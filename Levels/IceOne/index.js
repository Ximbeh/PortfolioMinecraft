...
const player = new Player({
  position: proximaFase==="florestaCincoParaGeloUm"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "geloDoisparaGeloUm"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "geloUmParaGeloDois")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "geloUmParaFlorestaCinco")
        // player.lastDirection = "left";
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
            window.location.href = '../ForestFifth/index.html';
            gsap.to(overlay, {
                opacity: 0,
            })
          }
