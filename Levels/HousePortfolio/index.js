  ...
  animations: {
    ...
    EnterDoor: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("saiuHouse", "portfolio");
    ...
    case " ":
      ...
      if (
        ...
        player.hitbox.position.y + player.hitbox.height >=
          Frame[0].position.y &&
        player.hitbox.position.y <= Frame[0].position.y + Frame[0].height
      ) { 
        window.open('https://www.canva.com/design/DAE9PgFZH7Q/1hAtp2BcM7VbXOUH4E6rGg/view?utm_content=DAE9PgFZH7Q&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink', '_blank')
          console.log("quadro1");
        return;
      }
      if (
        ...
        player.hitbox.position.y + player.hitbox.height >=
          Frame[1].position.y &&
        player.hitbox.position.y <= Frame[1].position.y + Frame[1].height
      ) { 
        window.open('https://www.canva.com/design/DAEn6iR4tgM/B_hlYkILys5xex3jCg-z0w/view?utm_content=DAEn6iR4tgM&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink', '_blank')
          console.log("quadro2");
        return;
      }
      if (
        ...
        player.hitbox.position.y + player.hitbox.height >=
          Frame[2].position.y &&
        player.hitbox.position.y <= Frame[2].position.y + Frame[2].height
      ) {
        window.open('https://caireportfolio.netlify.app', '_blank')
          console.log("quadro3");
        return;
      }
