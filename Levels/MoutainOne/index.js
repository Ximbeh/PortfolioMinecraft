...
const player = new Player({
  position: proximaFase==="geloDoisParaMontanhaUm"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "montanhaDoisParaMontanhaUm"?{
    x: 940,
    y: 50,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "montanhaUmParaMontanhaDois")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "montanhaUmParaGeloDois")
