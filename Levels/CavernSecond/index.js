...
const player = new Player({
  position
  : proximaFase==="cavernaUmParaCavernaDois"?{
    x: 2,
    y: 300,
  }
  : voltaFase = "cavernaTresParaCavernaDois"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "cavernaDoisParaCavernaTres")
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "cavernaDoisParaCavernaUm")
