...
const player = new Player({
  position
  : proximaFase==="netherTresParaNetherQuatro"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "cavernaSeteParaNetherQuatro"?{
    x: 400,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "netherQuatroParaNetherTres")
          ...
          if (
            ...
            gsap.to(overlay, {
              ...
              onComplete: () => {
                ...
                sessionStorage.setItem("proximaFase", "netherQuatroParaCavernaSete");
                // player.lastDirection = "left";
                window.location.href = '../CavernSeven/index.html';
                gsap.to(overlay, {
                  opacity: 0,
                });
              },
