...
const player = new Player({
  position
  : proximaFase==="netherDoisParaNetherTres"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "netherQuatroParaNetherTres"?{
    x: 940,
    y: 0,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "netherTresParaNetherQuatro")
        sessionStorage.setItem("saiuHouse", "false")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
            window.location.href = '../NetherFourth/index.html';
            gsap.to(overlay, {
                opacity: 0,
            })
          }
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "netherTresParaNetherDois")
    ...
    case "w":
      ...
      for (let i = 0; i < NPCS.length; i++) {
        ...
        if (
          ...
          window.open('https://www.canva.com/design/DAF1I1bGYHw/J1P4V0ApGD1UbVru8U0Z0g/edit?utm_content=DAF1I1bGYHw&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton', '_blank');
        }
      break;
      }
  }
