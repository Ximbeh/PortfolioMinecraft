...
const player = new Player({
  position
  : proximaFase==="netherParaNetherDois"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "netherTresParaNetherDois"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "netherDoisParaNetherTres")
        sessionStorage.setItem("saiuHouse", "false")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
            window.location.href = '../NetherThird/index.html';
            gsap.to(overlay, {
                opacity: 0,
            })
          }
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "netherDoisParaNetherUm")
    ...
    case "w":
      ...
      for (let i = 0; i < NPCS.length; i++) {
        ...
        if (
          ...
          window.open('https://www.canva.com/design/DAF1I0llymE/3IBmvwV-G9ORnpGlSLI7xw/view?utm_content=DAF1I0llymE&utm_campaign=designshare&utm_medium=link&utm_source=editor', '_blank');
        }
      break;
      }
  }
