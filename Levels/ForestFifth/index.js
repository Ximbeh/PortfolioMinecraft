...
const player = new Player({
  position: proximaFase==="florestaQuatroParaFlorestaCinco"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "geloUmParaFlorestaCinco"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "florestaCincoParaGeloUm")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "florestaCincoParaFlorestaQuatro")
