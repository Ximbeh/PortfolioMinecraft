...
const player = new Player({
  position: proximaFase==="florestaDoisParaFlorestaTres"?{
    x: 2,
    y: 320,
  }
  : proximaFase = "florestaQuatroParaFlorestaTres"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "florestaTresParaFlorestaQuatro")
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "florestaTresParaFlorestaDois")
