...
const player = new Player({
  position
  : proximaFase==="cavernaQuatroParaCavernaCinco"?{
    x: 250,
    y: 400,
  }
  : voltaFase = "cavernaSeisParaCavernaCinco"?{
    x: 620,
    y: 400,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "cavernaCincoParaCavernaSeis")
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "cavernaCincoParaCavernaQuatro")
        // player.lastDirection = "left";
        gsap.to(overlay, {
          opacity: 1,
          onComplete: () => {
            window.location.href = '../CavernFourth/index.html';
            gsap.to(overlay, {
                opacity: 0,
            })
          }
    ...
    case "w":
      ...
      for (let i = 0; i < NPCS.length; i++) {
        ...
        if (
          ...
          window.open('https://www.canva.com/design/DAF1I0ovR6E/YzHfh0G4jlaXqDRXe_LSew/view?utm_content=DAF1I0ovR6E&utm_campaign=designshare&utm_medium=link&utm_source=editor', '_blank');
        }
      break;
      }
  }
