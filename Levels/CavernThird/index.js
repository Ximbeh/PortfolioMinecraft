...
const player = new Player({
  position
  : proximaFase==="cavernaDoisParaCavernaTres"?{
    x: 2,
    y: 200,
  }
  : voltaFase = "cavernaQuatroParaCavernaTres"?{
    x: 940,
    y: 320,
  }
  :
  ...
  animations: {
    ...
    NextLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("proximaFase", "cavernaTresParaCavernaQuatro")
    ...
    BackLevel: {
      ...
      onComplete: () => {
        ...
        sessionStorage.setItem("voltaFase", "cavernaTresParaCavernaDois")
    ...
    case "w":
      ...
      for (let i = 0; i < NPCS.length; i++) {
        ...
        if (
          ...
          window.open('https://www.canva.com/design/DAF1Ims2T5A/HnEmmgWAXCBkVkOS6Ql8vw/view?utm_content=DAF1Ims2T5A&utm_campaign=designshare&utm_medium=link&utm_source=editor', '_blank');
        }
      break;
  }
}
